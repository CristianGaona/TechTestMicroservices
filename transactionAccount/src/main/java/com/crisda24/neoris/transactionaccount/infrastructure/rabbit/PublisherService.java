...
import com.crisda24.neoris.transactionaccount.application.common.dtos.account.messages.ClientIdListMessage;
...
public class PublisherService {
    ...
    public PublisherService(AmqpTemplate template, ObjectMapper mapper) {
